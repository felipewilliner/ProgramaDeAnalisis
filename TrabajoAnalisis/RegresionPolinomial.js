document.addEventListener("DOMContentLoaded", function () {
    console.info("Formulario de Regresión Polinomial Listo");

    // Inicializar con dos puntos de ejemplo
    agregarFilaPunto(1, 2);
    agregarFilaPunto(3, 4);

    document.getElementById('regresionPolinomialForm').addEventListener('submit', function (event) {
...
function calcularRegresion() {
    ...
    fetch('http://localhost:5125/api/Unidad3/regresionpolinomial', {
        method: 'POST',
        headers: {
